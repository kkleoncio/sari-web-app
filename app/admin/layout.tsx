...
export default async function AdminLayout({
  ...
  <div className="flex h-full">
        <aside className="relative hidden h-screen w-[285px] shrink-0 overflow-y-auto border-r border-white/60 bg-white/75 px-6 py-7 shadow-[8px_0_30px_rgba(15,23,42,0.03)] backdrop-blur-xl lg:flex lg:flex-col">          <div className="pointer-events-none absolute -left-10 top-10 h-32 w-32 rounded-full bg-emerald-100/50 blur-3xl" />
